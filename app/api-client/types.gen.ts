...
export type UserProfile = {
    ...
    t_shirt_size?: ('XXS' | 'XS' | 'S' | 'M' | 'L' | 'XL' | 'XXL' | 'XXXL') | null;
    country?: (string) | null;
    city?: (string) | null;
...
export type Event = {
    name: string;
    competition_type: 'running' | 'trail' | 'ultramarathon' | 'cycling' | 'online' | 'walking' | 'ocr' | 'swimming' | 'triathlon';
    date_from: Date;
    date_to: Date;
    place: string;
...
export type AuthRegisterCreateResponse = (unknown);
...
export type AuthTokenCreateResponse = (TokenObtainPair);
